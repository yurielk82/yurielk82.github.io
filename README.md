...
**AI Full-Stack Builder 포트폴리오** v2.0.0
...
| 특징 | 설명 |
|------|------|
| Apple Bento Grid | 비대칭 카드 크기로 정보 위계와 시각적 리듬감 부여 (4열 반응형) |
| Liquid Glass 디자인 | Apple WWDC 2025 영감 — 반투명 머티리얼 + 스펙큘러 하이라이트 |
| 타이핑 애니메이션 | Hero 타이틀 TypeWriter + Stat 카운트업 애니메이션 |
| CSS 블롭 그래디언트 배경 | 인디고/바이올렛/퓨샤 3개 블롭 느린 드리프트 |
| Featured 솔루션 카드 | 대형 Featured(3x2) + Compact 조합 Bento Grid |
| 통합 Skills Bento | 역량 카드 + 기술 스택 아이콘 단일 그리드 통합 |
| 섹션 구분선 | 그래디언트 구분선으로 섹션 간 시각적 전환 |
...
│   ├── shared/         # BentoCard, GlassCard, TypeWriter, CountUp, SectionDivider, SectionHeading, AnimatedBackground, TechBadge, LiquidGlassSVGFilters
│   └── ui/             # shadcn/ui
